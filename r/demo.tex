...
\includegraphics{demo_files/figure-pdf/unnamed-chunk-11-1.pdf}
...
\includegraphics{demo_files/figure-pdf/unnamed-chunk-15-1.pdf}
...
\includegraphics{demo_files/figure-pdf/unnamed-chunk-24-1.pdf}
...
\NormalTok{util}\SpecialCharTok{$}\FunctionTok{plot\_conditional\_mean\_quantiles}\NormalTok{(samples, pred\_names, data}\SpecialCharTok{$}\NormalTok{X[,}\DecValTok{1}\NormalTok{],}
                                     \SpecialCharTok{{-}}\DecValTok{9}\NormalTok{, }\DecValTok{9}\NormalTok{, }\DecValTok{1}\NormalTok{, data}\SpecialCharTok{$}\NormalTok{y, }\ConstantTok{TRUE}\NormalTok{, }\AttributeTok{xlab=}\StringTok{"x1"}\NormalTok{)}
\NormalTok{util}\SpecialCharTok{$}\FunctionTok{plot\_conditional\_mean\_quantiles}\NormalTok{(samples, pred\_names, data}\SpecialCharTok{$}\NormalTok{X[,}\DecValTok{2}\NormalTok{],}
                                     \SpecialCharTok{{-}}\DecValTok{9}\NormalTok{, }\DecValTok{9}\NormalTok{, }\DecValTok{1}\NormalTok{, data}\SpecialCharTok{$}\NormalTok{y, }\ConstantTok{TRUE}\NormalTok{, }\AttributeTok{xlab=}\StringTok{"x2"}\NormalTok{)}
\NormalTok{util}\SpecialCharTok{$}\FunctionTok{plot\_conditional\_mean\_quantiles}\NormalTok{(samples, pred\_names, data}\SpecialCharTok{$}\NormalTok{X[,}\DecValTok{3}\NormalTok{],}
                                     \SpecialCharTok{{-}}\DecValTok{9}\NormalTok{, }\DecValTok{9}\NormalTok{, }\DecValTok{1}\NormalTok{, data}\SpecialCharTok{$}\NormalTok{y, }\ConstantTok{TRUE}\NormalTok{, }\AttributeTok{xlab=}\StringTok{"x3"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{util}\SpecialCharTok{$}\FunctionTok{plot\_disc\_pushforward\_quantiles}\NormalTok{(samples, names,}
                                     ...
                                     \AttributeTok{residual=}\ConstantTok{TRUE}\NormalTok{,}
                                     \AttributeTok{xlab=}\StringTok{"All Slopes"}\NormalTok{,}
                                     \AttributeTok{ylab=}\StringTok{"Marginal Posterior Quantile Residuals"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
