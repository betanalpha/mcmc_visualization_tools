...
\NormalTok{util}\SpecialCharTok{$}\FunctionTok{plot\_line\_hist}\NormalTok{(data}\SpecialCharTok{$}\NormalTok{x,}
                    \AttributeTok{breaks=}\FunctionTok{c}\NormalTok{(}\SpecialCharTok{{-}}\DecValTok{6}\NormalTok{, }\SpecialCharTok{{-}}\DecValTok{3}\NormalTok{, }\SpecialCharTok{{-}}\FloatTok{1.5}\NormalTok{, }\SpecialCharTok{{-}}\FloatTok{0.75}\NormalTok{, }\DecValTok{0}\NormalTok{, }\FloatTok{0.75}\NormalTok{, }\FloatTok{1.5}\NormalTok{, }\DecValTok{3}\NormalTok{, }\DecValTok{6}\NormalTok{),}
                    \AttributeTok{xlab=}\StringTok{"x"}\NormalTok{, }\AttributeTok{main=}\StringTok{"Observed Inputs"}\NormalTok{)}

\NormalTok{util}\SpecialCharTok{$}\FunctionTok{plot\_line\_hist}\NormalTok{(data}\SpecialCharTok{$}\NormalTok{y,}
                    \AttributeTok{breaks=}\FunctionTok{c}\NormalTok{(}\SpecialCharTok{{-}}\DecValTok{4}\NormalTok{, }\DecValTok{0}\NormalTok{, }\DecValTok{7}\NormalTok{),}
                    \AttributeTok{xlab=}\StringTok{"y"}\NormalTok{, }\AttributeTok{main=}\StringTok{"Observed Outputs"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{util}\SpecialCharTok{$}\FunctionTok{plot\_line\_hist}\NormalTok{(data}\SpecialCharTok{$}\NormalTok{x, }\SpecialCharTok{{-}}\DecValTok{6}\NormalTok{, }\DecValTok{6}\NormalTok{, }\FloatTok{0.5}\NormalTok{,}
                    \AttributeTok{col=}\StringTok{"black"}\NormalTok{, }\AttributeTok{add=}\ConstantTok{TRUE}\NormalTok{)}
\NormalTok{util}\SpecialCharTok{$}\FunctionTok{plot\_line\_hist}\NormalTok{(data}\SpecialCharTok{$}\NormalTok{y, }\SpecialCharTok{{-}}\DecValTok{4}\NormalTok{, }\DecValTok{7}\NormalTok{, }\FloatTok{0.5}\NormalTok{,}
                    \AttributeTok{col=}\NormalTok{util}\SpecialCharTok{$}\NormalTok{c\_mid\_teal, }\AttributeTok{add=}\ConstantTok{TRUE}\NormalTok{)}
...
\includegraphics{demo_files/figure-pdf/unnamed-chunk-10-1.pdf}
...
\NormalTok{f\_names }\OtherTok{\textless{}{-}} \FunctionTok{sapply}\NormalTok{(}\DecValTok{1}\SpecialCharTok{:}\NormalTok{data}\SpecialCharTok{$}\NormalTok{N\_grid,}
                  \ControlFlowTok{function}\NormalTok{(n) }\FunctionTok{paste0}\NormalTok{(}\StringTok{\textquotesingle{}f\_grid[\textquotesingle{}}\NormalTok{, n, }\StringTok{\textquotesingle{}]\textquotesingle{}}\NormalTok{))}
...
\NormalTok{util}\SpecialCharTok{$}\FunctionTok{plot\_conn\_pushforward\_quantiles}\NormalTok{(}
\NormalTok{  samples, f\_names, data}\SpecialCharTok{$}\NormalTok{x\_grid,}
  \AttributeTok{xlab=}\StringTok{"x"}\NormalTok{, }\AttributeTok{ylab=}\StringTok{"f"}
\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{pred\_names }\OtherTok{\textless{}{-}} \FunctionTok{sapply}\NormalTok{(}\DecValTok{1}\SpecialCharTok{:}\NormalTok{data}\SpecialCharTok{$}\NormalTok{N\_grid,}
                     \ControlFlowTok{function}\NormalTok{(n) }\FunctionTok{paste0}\NormalTok{(}\StringTok{\textquotesingle{}y\_pred\_grid[\textquotesingle{}}\NormalTok{, n, }\StringTok{\textquotesingle{}]\textquotesingle{}}\NormalTok{))}
\NormalTok{util}\SpecialCharTok{$}\FunctionTok{plot\_conn\_pushforward\_quantiles}\NormalTok{(}
\NormalTok{  samples, pred\_names, data}\SpecialCharTok{$}\NormalTok{x\_grid,}
  \AttributeTok{xlab=}\StringTok{"x"}\NormalTok{, }\AttributeTok{ylab=}\StringTok{"y"}
\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{demo_files/figure-pdf/unnamed-chunk-14-1.pdf}
...
\FunctionTok{plot}\NormalTok{(data}\SpecialCharTok{$}\NormalTok{X[,}\DecValTok{1}\NormalTok{], data}\SpecialCharTok{$}\NormalTok{X[,}\DecValTok{2}\NormalTok{],}
     \AttributeTok{pch=}\DecValTok{16}\NormalTok{, }\AttributeTok{cex=}\FloatTok{1.0}\NormalTok{, }\AttributeTok{col=}\StringTok{"black"}\NormalTok{, }\AttributeTok{main=}\StringTok{""}\NormalTok{,}
     \AttributeTok{xlim=}\FunctionTok{c}\NormalTok{(}\SpecialCharTok{{-}}\DecValTok{9}\NormalTok{, }\DecValTok{9}\NormalTok{), }\AttributeTok{xlab=}\StringTok{"x1"}\NormalTok{, }\AttributeTok{ylim=}\FunctionTok{c}\NormalTok{(}\SpecialCharTok{{-}}\DecValTok{9}\NormalTok{, }\DecValTok{9}\NormalTok{), }\AttributeTok{ylab=}\StringTok{"x2"}\NormalTok{)}

\FunctionTok{plot}\NormalTok{(data}\SpecialCharTok{$}\NormalTok{X[,}\DecValTok{1}\NormalTok{], data}\SpecialCharTok{$}\NormalTok{X[,}\DecValTok{3}\NormalTok{],}
     \AttributeTok{pch=}\DecValTok{16}\NormalTok{, }\AttributeTok{cex=}\FloatTok{1.0}\NormalTok{, }\AttributeTok{col=}\StringTok{"black"}\NormalTok{, }\AttributeTok{main=}\StringTok{""}\NormalTok{,}
     \AttributeTok{xlim=}\FunctionTok{c}\NormalTok{(}\SpecialCharTok{{-}}\DecValTok{9}\NormalTok{, }\DecValTok{9}\NormalTok{), }\AttributeTok{xlab=}\StringTok{"x1"}\NormalTok{, }\AttributeTok{ylim=}\FunctionTok{c}\NormalTok{(}\SpecialCharTok{{-}}\DecValTok{9}\NormalTok{, }\DecValTok{9}\NormalTok{), }\AttributeTok{ylab=}\StringTok{"x3"}\NormalTok{)}

\FunctionTok{plot}\NormalTok{(data}\SpecialCharTok{$}\NormalTok{X[,}\DecValTok{2}\NormalTok{], data}\SpecialCharTok{$}\NormalTok{X[,}\DecValTok{3}\NormalTok{],}
     \AttributeTok{pch=}\DecValTok{16}\NormalTok{, }\AttributeTok{cex=}\FloatTok{1.0}\NormalTok{, }\AttributeTok{col=}\StringTok{"black"}\NormalTok{, }\AttributeTok{main=}\StringTok{""}\NormalTok{,}
     \AttributeTok{xlim=}\FunctionTok{c}\NormalTok{(}\SpecialCharTok{{-}}\DecValTok{9}\NormalTok{, }\DecValTok{9}\NormalTok{), }\AttributeTok{xlab=}\StringTok{"x2"}\NormalTok{, }\AttributeTok{ylim=}\FunctionTok{c}\NormalTok{(}\SpecialCharTok{{-}}\DecValTok{9}\NormalTok{, }\DecValTok{9}\NormalTok{), }\AttributeTok{ylab=}\StringTok{"x3"}\NormalTok{)}

\FunctionTok{plot}\NormalTok{(data}\SpecialCharTok{$}\NormalTok{X[,}\DecValTok{1}\NormalTok{], data}\SpecialCharTok{$}\NormalTok{y,}
     \AttributeTok{pch=}\DecValTok{16}\NormalTok{, }\AttributeTok{cex=}\FloatTok{1.0}\NormalTok{, }\AttributeTok{col=}\StringTok{"black"}\NormalTok{, }\AttributeTok{main=}\StringTok{""}\NormalTok{,}
     \AttributeTok{xlim=}\FunctionTok{c}\NormalTok{(}\SpecialCharTok{{-}}\DecValTok{9}\NormalTok{, }\DecValTok{9}\NormalTok{), }\AttributeTok{xlab=}\StringTok{"x1"}\NormalTok{, }\AttributeTok{ylim=}\FunctionTok{c}\NormalTok{(}\SpecialCharTok{{-}}\DecValTok{25}\NormalTok{, }\DecValTok{325}\NormalTok{), }\AttributeTok{ylab=}\StringTok{"y"}\NormalTok{)}

\FunctionTok{plot}\NormalTok{(data}\SpecialCharTok{$}\NormalTok{X[,}\DecValTok{2}\NormalTok{], data}\SpecialCharTok{$}\NormalTok{y,}
     \AttributeTok{pch=}\DecValTok{16}\NormalTok{, }\AttributeTok{cex=}\FloatTok{1.0}\NormalTok{, }\AttributeTok{col=}\StringTok{"black"}\NormalTok{, }\AttributeTok{main=}\StringTok{""}\NormalTok{,}
     \AttributeTok{xlim=}\FunctionTok{c}\NormalTok{(}\SpecialCharTok{{-}}\DecValTok{9}\NormalTok{, }\DecValTok{9}\NormalTok{), }\AttributeTok{xlab=}\StringTok{"x2"}\NormalTok{, }\AttributeTok{ylim=}\FunctionTok{c}\NormalTok{(}\SpecialCharTok{{-}}\DecValTok{25}\NormalTok{, }\DecValTok{325}\NormalTok{), }\AttributeTok{ylab=}\StringTok{"y"}\NormalTok{)}

\FunctionTok{plot}\NormalTok{(data}\SpecialCharTok{$}\NormalTok{X[,}\DecValTok{3}\NormalTok{], data}\SpecialCharTok{$}\NormalTok{y,}
     \AttributeTok{pch=}\DecValTok{16}\NormalTok{, }\AttributeTok{cex=}\FloatTok{1.0}\NormalTok{, }\AttributeTok{col=}\StringTok{"black"}\NormalTok{, }\AttributeTok{main=}\StringTok{""}\NormalTok{,}
     \AttributeTok{xlim=}\FunctionTok{c}\NormalTok{(}\SpecialCharTok{{-}}\DecValTok{9}\NormalTok{, }\DecValTok{9}\NormalTok{), }\AttributeTok{xlab=}\StringTok{"x3"}\NormalTok{, }\AttributeTok{ylim=}\FunctionTok{c}\NormalTok{(}\SpecialCharTok{{-}}\DecValTok{25}\NormalTok{, }\DecValTok{325}\NormalTok{), }\AttributeTok{ylab=}\StringTok{"y"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{demo_files/figure-pdf/unnamed-chunk-23-1.pdf}
...
\NormalTok{util}\SpecialCharTok{$}\FunctionTok{plot\_hist\_quantiles}\NormalTok{(samples, }\StringTok{\textquotesingle{}y\_pred\textquotesingle{}}\NormalTok{, }\SpecialCharTok{{-}}\DecValTok{400}\NormalTok{, }\DecValTok{400}\NormalTok{, }\DecValTok{50}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
Warning in check_bin_containment(bin_min, bin_max, collapsed_values,
"predictive value"): 107 predictive values (0.0%) fell below the binning.
\end{verbatim}

\begin{verbatim}
Warning in check_bin_containment(bin_min, bin_max, collapsed_values,
"predictive value"): 123 predictive values (0.0%) fell above the binning.
\end{verbatim}
...
\NormalTok{util}\SpecialCharTok{$}\FunctionTok{plot\_hist\_quantiles}\NormalTok{(samples, }\StringTok{\textquotesingle{}y\_pred\textquotesingle{}}\NormalTok{,}
                         \AttributeTok{breaks=}\FunctionTok{c}\NormalTok{(}\SpecialCharTok{{-}}\DecValTok{400}\NormalTok{, }\SpecialCharTok{{-}}\DecValTok{200}\NormalTok{, }\SpecialCharTok{{-}}\DecValTok{100}\NormalTok{, }\SpecialCharTok{{-}}\DecValTok{50}\NormalTok{, }\SpecialCharTok{{-}}\DecValTok{25}\NormalTok{, }\DecValTok{0}\NormalTok{,}
...
\includegraphics{demo_files/figure-pdf/unnamed-chunk-28-1.pdf}
...
\NormalTok{pred\_names }\OtherTok{\textless{}{-}} \FunctionTok{sapply}\NormalTok{(}\DecValTok{1}\SpecialCharTok{:}\NormalTok{data}\SpecialCharTok{$}\NormalTok{N,}
...
\NormalTok{util}\SpecialCharTok{$}\FunctionTok{plot\_conditional\_mean\_quantiles}\NormalTok{(}
\NormalTok{  samples, pred\_names, data}\SpecialCharTok{$}\NormalTok{X[,}\DecValTok{1}\NormalTok{],}
  \SpecialCharTok{{-}}\DecValTok{9}\NormalTok{, }\DecValTok{9}\NormalTok{, }\DecValTok{1}\NormalTok{, }\AttributeTok{xlab=}\StringTok{"x1"}
\NormalTok{  )}
\NormalTok{util}\SpecialCharTok{$}\FunctionTok{plot\_conditional\_mean\_quantiles}\NormalTok{(}
\NormalTok{  samples, pred\_names, data}\SpecialCharTok{$}\NormalTok{X[,}\DecValTok{2}\NormalTok{],}
  \SpecialCharTok{{-}}\DecValTok{9}\NormalTok{, }\DecValTok{9}\NormalTok{, }\DecValTok{1}\NormalTok{,}\AttributeTok{xlab=}\StringTok{"x2"}
\NormalTok{  )}
\NormalTok{util}\SpecialCharTok{$}\FunctionTok{plot\_conditional\_mean\_quantiles}\NormalTok{(}
\NormalTok{  samples, pred\_names, data}\SpecialCharTok{$}\NormalTok{X[,}\DecValTok{3}\NormalTok{],}
  \SpecialCharTok{{-}}\DecValTok{9}\NormalTok{, }\DecValTok{9}\NormalTok{, }\DecValTok{1}\NormalTok{, }\AttributeTok{xlab=}\StringTok{"x3"}
\NormalTok{  )}
\end{Highlighting}
\end{Shaded}

\includegraphics{demo_files/figure-pdf/unnamed-chunk-29-1.pdf}
...
\NormalTok{pred\_names }\OtherTok{\textless{}{-}} \FunctionTok{sapply}\NormalTok{(}\DecValTok{1}\SpecialCharTok{:}\NormalTok{data}\SpecialCharTok{$}\NormalTok{N,}
                     \ControlFlowTok{function}\NormalTok{(n) }\FunctionTok{paste0}\NormalTok{(}\StringTok{\textquotesingle{}y\_pred[\textquotesingle{}}\NormalTok{, n, }\StringTok{\textquotesingle{}]\textquotesingle{}}\NormalTok{))}
\NormalTok{util}\SpecialCharTok{$}\FunctionTok{plot\_conditional\_median\_quantiles}\NormalTok{(}
\NormalTok{  samples, pred\_names, data}\SpecialCharTok{$}\NormalTok{X[,}\DecValTok{1}\NormalTok{],}
  \SpecialCharTok{{-}}\DecValTok{9}\NormalTok{, }\DecValTok{9}\NormalTok{, }\DecValTok{1}\NormalTok{, }\AttributeTok{xlab=}\StringTok{"x1"}
\NormalTok{)}
\NormalTok{util}\SpecialCharTok{$}\FunctionTok{plot\_conditional\_median\_quantiles}\NormalTok{(}
...
\NormalTok{util}\SpecialCharTok{$}\FunctionTok{plot\_conditional\_mean\_quantiles}\NormalTok{(}
\NormalTok{  samples, pred\_names, data}\SpecialCharTok{$}\NormalTok{X[,}\DecValTok{1}\NormalTok{],}
  \SpecialCharTok{{-}}\DecValTok{9}\NormalTok{, }\DecValTok{9}\NormalTok{, }\DecValTok{1}\NormalTok{, data}\SpecialCharTok{$}\NormalTok{y, }\AttributeTok{residual=}\ConstantTok{TRUE}\NormalTok{, }\AttributeTok{xlab=}\StringTok{"x1"}\NormalTok{)}
\NormalTok{util}\SpecialCharTok{$}\FunctionTok{plot\_conditional\_mean\_quantiles}\NormalTok{(}
\NormalTok{  samples, pred\_names, data}\SpecialCharTok{$}\NormalTok{X[,}\DecValTok{2}\NormalTok{],}
  \SpecialCharTok{{-}}\DecValTok{9}\NormalTok{, }\DecValTok{9}\NormalTok{, }\DecValTok{1}\NormalTok{, data}\SpecialCharTok{$}\NormalTok{y, }\AttributeTok{residual=}\ConstantTok{TRUE}\NormalTok{, }\AttributeTok{xlab=}\StringTok{"x2"}\NormalTok{)}
\NormalTok{util}\SpecialCharTok{$}\FunctionTok{plot\_conditional\_mean\_quantiles}\NormalTok{(}
\NormalTok{  samples, pred\_names, data}\SpecialCharTok{$}\NormalTok{X[,}\DecValTok{3}\NormalTok{],}
  \SpecialCharTok{{-}}\DecValTok{9}\NormalTok{, }\DecValTok{9}\NormalTok{, }\DecValTok{1}\NormalTok{, data}\SpecialCharTok{$}\NormalTok{y, }\AttributeTok{residual=}\ConstantTok{TRUE}\NormalTok{, }\AttributeTok{xlab=}\StringTok{"x3"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{util}\SpecialCharTok{$}\FunctionTok{plot\_conditional\_median\_quantiles}\NormalTok{(}
\NormalTok{  samples, pred\_names, data}\SpecialCharTok{$}\NormalTok{X[,}\DecValTok{1}\NormalTok{],}
  \SpecialCharTok{{-}}\DecValTok{9}\NormalTok{, }\DecValTok{9}\NormalTok{, }\DecValTok{1}\NormalTok{, data}\SpecialCharTok{$}\NormalTok{y, }\AttributeTok{xlab=}\StringTok{"x1"}
\NormalTok{)}
\NormalTok{util}\SpecialCharTok{$}\FunctionTok{plot\_conditional\_median\_quantiles}\NormalTok{(}
\NormalTok{  samples, pred\_names, data}\SpecialCharTok{$}\NormalTok{X[,}\DecValTok{2}\NormalTok{],}
  \SpecialCharTok{{-}}\DecValTok{9}\NormalTok{, }\DecValTok{9}\NormalTok{, }\DecValTok{1}\NormalTok{, data}\SpecialCharTok{$}\NormalTok{y, }\AttributeTok{xlab=}\StringTok{"x2"}
\NormalTok{)}
\NormalTok{util}\SpecialCharTok{$}\FunctionTok{plot\_conditional\_median\_quantiles}\NormalTok{(}
\NormalTok{  samples, pred\_names, data}\SpecialCharTok{$}\NormalTok{X[,}\DecValTok{3}\NormalTok{],}
  \SpecialCharTok{{-}}\DecValTok{9}\NormalTok{, }\DecValTok{9}\NormalTok{, }\DecValTok{1}\NormalTok{, data}\SpecialCharTok{$}\NormalTok{y, }\AttributeTok{xlab=}\StringTok{"x3"}
\NormalTok{)}
\NormalTok{util}\SpecialCharTok{$}\FunctionTok{plot\_conditional\_median\_quantiles}\NormalTok{(}
\NormalTok{  samples, pred\_names, data}\SpecialCharTok{$}\NormalTok{X[,}\DecValTok{1}\NormalTok{],}
  \SpecialCharTok{{-}}\DecValTok{9}\NormalTok{, }\DecValTok{9}\NormalTok{, }\DecValTok{1}\NormalTok{, data}\SpecialCharTok{$}\NormalTok{y, }\AttributeTok{residual=}\ConstantTok{TRUE}\NormalTok{, }\AttributeTok{xlab=}\StringTok{"x1"}
\NormalTok{)}
\NormalTok{util}\SpecialCharTok{$}\FunctionTok{plot\_conditional\_median\_quantiles}\NormalTok{(}
\NormalTok{  samples, pred\_names, data}\SpecialCharTok{$}\NormalTok{X[,}\DecValTok{2}\NormalTok{],}
  \SpecialCharTok{{-}}\DecValTok{9}\NormalTok{, }\DecValTok{9}\NormalTok{, }\DecValTok{1}\NormalTok{, data}\SpecialCharTok{$}\NormalTok{y, }\AttributeTok{residual=}\ConstantTok{TRUE}\NormalTok{, }\AttributeTok{xlab=}\StringTok{"x2"}
\NormalTok{)}
\NormalTok{util}\SpecialCharTok{$}\FunctionTok{plot\_conditional\_median\_quantiles}\NormalTok{(}
\NormalTok{  samples, pred\_names, data}\SpecialCharTok{$}\NormalTok{X[,}\DecValTok{3}\NormalTok{],}
  \SpecialCharTok{{-}}\DecValTok{9}\NormalTok{, }\DecValTok{9}\NormalTok{, }\DecValTok{1}\NormalTok{, data}\SpecialCharTok{$}\NormalTok{y, }\AttributeTok{residual=}\ConstantTok{TRUE}\NormalTok{, }\AttributeTok{xlab=}\StringTok{"x3"}
\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{names }\OtherTok{\textless{}{-}} \FunctionTok{sapply}\NormalTok{(}\DecValTok{1}\SpecialCharTok{:}\NormalTok{data}\SpecialCharTok{$}\NormalTok{M,}
                \ControlFlowTok{function}\NormalTok{(m) }\FunctionTok{paste0}\NormalTok{(}\StringTok{\textquotesingle{}beta1[\textquotesingle{}}\NormalTok{, m, }\StringTok{\textquotesingle{}]\textquotesingle{}}\NormalTok{))}
\NormalTok{util}\SpecialCharTok{$}\FunctionTok{plot\_disc\_pushforward\_quantiles}\NormalTok{(}
\NormalTok{  samples, names,}
  \AttributeTok{xlab=}\StringTok{"beta1"}\NormalTok{,}
  \AttributeTok{xticklabs=}\DecValTok{1}\SpecialCharTok{:}\NormalTok{data}\SpecialCharTok{$}\NormalTok{M,}
  \AttributeTok{ylab=}\StringTok{"Marginal Posterior Quantiles"}
\NormalTok{)}

\NormalTok{names }\OtherTok{\textless{}{-}} \FunctionTok{sapply}\NormalTok{(}\DecValTok{1}\SpecialCharTok{:}\NormalTok{data}\SpecialCharTok{$}\NormalTok{M,}
                \ControlFlowTok{function}\NormalTok{(m) }\FunctionTok{paste0}\NormalTok{(}\StringTok{\textquotesingle{}beta2\_d[\textquotesingle{}}\NormalTok{, m, }\StringTok{\textquotesingle{}]\textquotesingle{}}\NormalTok{))}
\NormalTok{util}\SpecialCharTok{$}\FunctionTok{plot\_disc\_pushforward\_quantiles}\NormalTok{(}
\NormalTok{  samples, names,}
...
\NormalTok{names }\OtherTok{\textless{}{-}} \FunctionTok{sapply}\NormalTok{(}\DecValTok{1}\SpecialCharTok{:}\NormalTok{data}\SpecialCharTok{$}\NormalTok{M,}
                \ControlFlowTok{function}\NormalTok{(m) }\FunctionTok{paste0}\NormalTok{(}\StringTok{\textquotesingle{}beta2\_o[\textquotesingle{}}\NormalTok{, m, }\StringTok{\textquotesingle{}]\textquotesingle{}}\NormalTok{))}
\NormalTok{util}\SpecialCharTok{$}\FunctionTok{plot\_disc\_pushforward\_quantiles}\NormalTok{(}
\NormalTok{  samples, names,}
...
\includegraphics{demo_files/figure-pdf/unnamed-chunk-37-1.pdf}

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{par}\NormalTok{(}\AttributeTok{mfrow=}\FunctionTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{, }\DecValTok{1}\NormalTok{))}

\NormalTok{names }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\FunctionTok{sapply}\NormalTok{(}\DecValTok{1}\SpecialCharTok{:}\NormalTok{data}\SpecialCharTok{$}\NormalTok{M,}
                  \ControlFlowTok{function}\NormalTok{(m) }\FunctionTok{paste0}\NormalTok{(}\StringTok{\textquotesingle{}beta1[\textquotesingle{}}\NormalTok{, m, }\StringTok{\textquotesingle{}]\textquotesingle{}}\NormalTok{)),}
           \FunctionTok{sapply}\NormalTok{(}\DecValTok{1}\SpecialCharTok{:}\NormalTok{data}\SpecialCharTok{$}\NormalTok{M,}
                  \ControlFlowTok{function}\NormalTok{(m) }\FunctionTok{paste0}\NormalTok{(}\StringTok{\textquotesingle{}beta2\_d[\textquotesingle{}}\NormalTok{, m, }\StringTok{\textquotesingle{}]\textquotesingle{}}\NormalTok{)),}
           \FunctionTok{sapply}\NormalTok{(}\DecValTok{1}\SpecialCharTok{:}\NormalTok{data}\SpecialCharTok{$}\NormalTok{M,}
                  \ControlFlowTok{function}\NormalTok{(m) }\FunctionTok{paste0}\NormalTok{(}\StringTok{\textquotesingle{}beta2\_o[\textquotesingle{}}\NormalTok{, m, }\StringTok{\textquotesingle{}]\textquotesingle{}}\NormalTok{)))}
\NormalTok{util}\SpecialCharTok{$}\FunctionTok{plot\_disc\_pushforward\_quantiles}\NormalTok{(}
...
\includegraphics{demo_files/figure-pdf/unnamed-chunk-38-1.pdf}

This plot style can also be rotated, which is helpful when working with
longer labels.
...
\NormalTok{names }\OtherTok{\textless{}{-}} \FunctionTok{sapply}\NormalTok{(}\DecValTok{1}\SpecialCharTok{:}\NormalTok{data}\SpecialCharTok{$}\NormalTok{M,}
                \ControlFlowTok{function}\NormalTok{(m) }\FunctionTok{paste0}\NormalTok{(}\StringTok{\textquotesingle{}beta1[\textquotesingle{}}\NormalTok{, m, }\StringTok{\textquotesingle{}]\textquotesingle{}}\NormalTok{))}
\NormalTok{util}\SpecialCharTok{$}\FunctionTok{plot\_disc\_pushforward\_quantiles\_vert}\NormalTok{(}
\NormalTok{  samples, names,}
  \AttributeTok{xlab=}\StringTok{"Marginal Posterior Quantiles"}\NormalTok{,}
  \AttributeTok{yticklabs=}\NormalTok{names}
\NormalTok{)}
...
\includegraphics{demo_files/figure-pdf/unnamed-chunk-39-1.pdf}
...
\NormalTok{  samples, names,}
  ...
  \AttributeTok{baseline\_col=}\NormalTok{util}\SpecialCharTok{$}\NormalTok{c\_mid\_teal,}
  \AttributeTok{xlab=}\StringTok{"All Slopes"}\NormalTok{,}
  \AttributeTok{ylab=}\StringTok{"Marginal Posterior}\SpecialCharTok{\textbackslash{}n}\StringTok{Quantiles"}
\NormalTok{)}
...
\NormalTok{  samples, names,}
  ...
  \AttributeTok{residual=}\ConstantTok{TRUE}\NormalTok{,}
  \AttributeTok{xlab=}\StringTok{"All Slopes"}\NormalTok{,}
  \AttributeTok{ylab=}\StringTok{"Marginal Posterior}\SpecialCharTok{\textbackslash{}n}\StringTok{Quantile Residuals"}
\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{demo_files/figure-pdf/unnamed-chunk-40-1.pdf}
