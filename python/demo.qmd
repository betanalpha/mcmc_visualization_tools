...
plot.rcParams['figure.figsize'] = [6, 8]
...
putil.plot_conn_pushforward_quantiles(plot.gca(), samples,
                                      pred_names, data['x_grid'],
                                      xlabel="x", ylabel="f")
plot.scatter(data['x'], data['y'], s=1, color="white")
plot.scatter(data['x'], data['y'], s=0.8, color="black")
...
f, axarr = plot.subplots(3, 3, layout="constrained")

putil.plot_line_hist(axarr[0, 0], data['X'][:,0], -9, 9, 1, xlabel="x1")
putil.plot_line_hist(axarr[0, 1], data['X'][:,1], -9, 9, 1, xlabel="x2")
putil.plot_line_hist(axarr[0, 2], data['X'][:,2], -9, 9, 1, xlabel="x3")

axarr[1, 0].scatter(data['X'][:,0], data['X'][:,1], color="black", s=2)
axarr[1, 0].set_xlim([-9, 9])
axarr[1, 0].set_xlabel("x1")
axarr[1, 0].set_ylim([-9, 9])
axarr[1, 0].set_ylabel("x2")

axarr[1, 1].scatter(data['X'][:,0], data['X'][:,2], color="black", s=2)
axarr[1, 1].set_xlim([-9, 9])
axarr[1, 1].set_xlabel("x1")
axarr[1, 1].set_ylim([-9, 9])
axarr[1, 1].set_ylabel("x3")

axarr[1, 2].scatter(data['X'][:,1], data['X'][:,2], color="black", s=2)
axarr[1, 2].set_xlim([-9, 9])
axarr[1, 2].set_xlabel("x2")
axarr[1, 2].set_ylim([-9, 9])
axarr[1, 2].set_ylabel("x3")

axarr[2, 0].scatter(data['X'][:,0], data['y'], color="black", s=2)
axarr[2, 0].set_xlim([-9, 9])
axarr[2, 0].set_xlabel("x1")
axarr[2, 0].set_ylim([-25, 325])
axarr[2, 0].set_ylabel("y")

axarr[2, 1].scatter(data['X'][:,1], data['y'], color="black", s=2)
axarr[2, 1].set_xlim([-9, 9])
axarr[2, 1].set_xlabel("x2")
axarr[2, 1].set_ylim([-25, 325])
axarr[2, 1].set_ylabel("y")

axarr[2, 2].scatter(data['X'][:,2], data['y'], color="black", s=2)
axarr[2, 2].set_xlim([-9, 9])
axarr[2, 2].set_xlabel("x3")
axarr[2, 2].set_ylim([-25, 325])
axarr[2, 2].set_ylabel("y")
...
pred_names = [ f'y_pred[{n + 1}]' for n in range(data['N']) ]
putil.plot_conditional_mean_quantiles(axarr[0, 0], samples, pred_names,
                                      data['X'][:,0], -9, 9, 1,
                                      data['y'], xlabel="x1")
putil.plot_conditional_mean_quantiles(axarr[0, 1], samples, pred_names,
                                      data['X'][:,1], -9, 9, 1,
                                      data['y'], xlabel="x2")
putil.plot_conditional_mean_quantiles(axarr[0, 2], samples, pred_names,
                                      data['X'][:,2], -9, 9, 1,
                                      data['y'], xlabel="x3")

putil.plot_conditional_mean_quantiles(axarr[1, 0], samples, pred_names,
                                      data['X'][:,0], -9, 9, 1,
                                      data['y'], True, xlabel="x1")
putil.plot_conditional_mean_quantiles(axarr[1, 1], samples, pred_names,
                                      data['X'][:,1], -9, 9, 1,
                                      data['y'], True, xlabel="x2")
putil.plot_conditional_mean_quantiles(axarr[1, 2], samples, pred_names,
                                      data['X'][:,2], -9, 9, 1,
                                      data['y'], True, xlabel="x3")
plot.show()
```
...
pred_names = [ f'y_pred[{n + 1}]' for n in range(data['N']) ]
putil.plot_conditional_median_quantiles(axarr[0, 0], samples, pred_names,
                                        data['X'][:,0], -9, 9, 1,
                                        data['y'], xlabel="x1")
putil.plot_conditional_median_quantiles(axarr[0, 1], samples, pred_names,
                                        data['X'][:,1], -9, 9, 1,
                                        data['y'], xlabel="x2")
putil.plot_conditional_median_quantiles(axarr[0, 2], samples, pred_names,
                                        data['X'][:,2], -9, 9, 1,
                                        data['y'], xlabel="x3")

putil.plot_conditional_median_quantiles(axarr[1, 0], samples, pred_names,
                                        data['X'][:,0], -9, 9, 1,
                                        data['y'], True, xlabel="x1")
putil.plot_conditional_median_quantiles(axarr[1, 1], samples, pred_names,
                                        data['X'][:,1], -9, 9, 1,
                                        data['y'], True, xlabel="x2")
putil.plot_conditional_median_quantiles(axarr[1, 2], samples, pred_names,
                                        data['X'][:,2], -9, 9, 1,
                                        data['y'], True, xlabel="x3")
plot.show()
```
